...
const initialState = {
	...
	post: {
		system_prompt:
			'Системный промт, например: Ты дружелюбный ассистент для разметки текстов',
		text_prompt:
			'Запрос к текстам, например: Какая тематика у этого текста, какие препараты рекомендуются к использованию? Ответь на русском языке в 1 предложение',
		texts: [],
	},
	// categories: {},
	idProgressBar: null,
